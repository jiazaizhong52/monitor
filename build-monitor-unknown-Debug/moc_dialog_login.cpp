...
#include "../monitor/dialog_login.h"
...
static const char qt_meta_stringdata_Dialog_Login[] = {
    "Dialog_Login\0"
};
...
const QMetaObjectExtraData Dialog_Login::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Dialog_Login::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Dialog_Login,
      qt_meta_data_Dialog_Login, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Dialog_Login::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Dialog_Login))
